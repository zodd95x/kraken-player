...
const config: Configuration = {
  // 应用程序的唯一标识符
  appId: "com.krakenplayer.app",
  // 应用程序的产品名称
  productName: "Kraken Player",
  copyright: "Copyright © imsyy 2023, Kraken Player contributors 2026",
  // 构建资源所在的目录
  directories: {
  ...
  linux: {
    ...
    // 维护者信息
    maintainer: "Kraken Player contributors",
    // 应用程序类别
