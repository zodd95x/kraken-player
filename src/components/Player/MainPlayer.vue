              ...
              <div v-else class="artists">
                <TextContainer :speed="0.5" class="artists-container">
                  ...
                  <n-text
                    v-else
                    class="ar-item"
                    :class="{ 'no-jump': !musicStore.playSong.artists }"
  ...
  return [
    {
      ...
      children: [
        ...
        {
          key: "share",
          label: trSetting("分享歌曲链接"),
          show: !isLocal,
          props: {
            onClick: () =>
              copyData(getShareUrl(song.type, song.id), trSetting("已复制分享链接到剪贴板")),
          },
