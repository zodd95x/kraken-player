<template>
  <n-layout-header class="nav">
    ...
    <n-flex :wrap="false" justify="end" class="nav-main">
      ...
      <n-flex align="center">
        ...
        <n-dropdown :options="setOptions" trigger="click" @select="setSelect">
          <n-button :focusable="false" :title="trSetting('设置')" tertiary circle>
            <template #icon>
            ...
            <template #header>
              <n-flex align="center" justify="center" class="aside-logo">
                ...
                <div class="brand-name">
                  <span class="brand-name-main">Kraken</span>
                  <span class="brand-name-sub">Player</span>
                </div>
              </n-flex>
            </template>
    ...
    >
      ...
      <div class="min-button-wrapper" @click="min" :title="trSetting('最小化')">
        <n-button :focusable="false" :title="trSetting('最小化')" tertiary circle @click.stop="min">
          <template #icon>
      ...
      <div
        class="max-button-wrapper"
        @click="maxOrRes"
        :title="isMax ? trSetting('向下还原') : trSetting('最大化')"
      >
        <n-button
          :focusable="false"
          :title="isMax ? trSetting('向下还原') : trSetting('最大化')"
      ...
      <div class="close-button-wrapper" @click="tryClose" :title="trSetting('关闭')">
        <n-button
          :focusable="false"
          :title="trSetting('关闭')"
          tertiary
    ...
    >
      <n-text class="tip">{{ trSetting("确定退出软件？") }}</n-text>
...
const setOptions = computed<DropdownOption[]>(() => [
  ...
  {
    label: trSetting("主题配置"),
    key: "themeConfig",
    icon: renderIcon("Palette"),
  },
  {
    label: trSetting("界面缩放"),
    key: "zoom",
  ...
  {
    key: "dev-tools",
    label: trSetting("开发者工具"),
    show: isDev,
    icon: renderIcon("Code"),
  },
  {
    key: "setting",
    label: trSetting("常规设置"),
