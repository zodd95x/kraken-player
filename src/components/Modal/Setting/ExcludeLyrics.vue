    ...
    <n-flex vertical size="large">
      <n-card class="switch-card" size="small">
        <n-flex align="center" justify="space-between">
          <n-text>Activer l'exclusion de paroles</n-text>
          <n-switch v-model:value="enableExcludeLyrics" :round="false" />
        </n-flex>
      </n-card>

      <n-tabs v-model:value="page" animated>
        <n-tab-pane name="options" tab="Options d'exclusion">
          <div class="set-list">
            <n-card class="set-item">
              <div class="label">
                <n-text class="name">Exclusion des paroles TTML</n-text>
                <n-text class="tip" :depth="3">
                  Appliquer le filtrage aux paroles TTML.<br />
            ...
            <n-card v-if="isElectron" class="set-item">
              <div class="label">
                <n-text class="name">Exclusion des paroles locales</n-text>
                <n-text class="tip" :depth="3">
        ...
        <n-tab-pane name="keywords" tab="Mots-clés de métadonnées">
          <n-scrollbar style="max-height: 50vh">
            <n-flex vertical :size="12">
              <n-text depth="3">Filtrage par mots-clés (mots précédant le deux-points)</n-text>
...
const exportFilters = () => {
  ...
  a.href = url;
  a.download = "kraken-player-lyrics-filters.json";
  a.click();
