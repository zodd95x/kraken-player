<template>
  <div class="song-unlock-manager">
    <n-alert title="Avertissement légal" type="info">
      Cette fonctionnalité est fournie à des fins de test. Les ressources proviennent du réseau. Si
      un contenu enfreint vos droits, veuillez nous contacter pour suppression.
    </n-alert>
