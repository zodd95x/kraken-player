    ...
    <Transition name="fade" mode="out-in">
      <div v-if="dataStore.downloadingSongs.length > 0" class="download-list">
        ...
        <div class="list-header sticky-header">
          ...
          <n-text class="title">Titre</n-text>
          <n-text class="status">Statut</n-text>
          <n-text class="actions">Actions</n-text>
        </div>
      ...
      <n-empty v-else description="Aucun téléchargement en cours" class="empty" />
    </Transition>
  </div>
</template>
...
const handleRemoveDownload = (id: number) => {
  ...
  window.$message.success("Tâche de téléchargement supprimée");
};
</script>
