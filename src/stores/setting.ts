...
export interface SettingState {
  ...
  /** Anti-AI：开启后在所有的地方都不显示 Hi-res 以上的音质选项 */
  disableAiAudio: boolean;
  /** Anti-DJ：开启后自动跳过 DJ 歌曲 */
...
export const useSettingStore = defineStore("setting", {
  state: (): SettingState => ({
    ...
    homePageSections: [
      { key: "playlist", name: "Playlists Tendance", visible: true, order: 0 },
      { key: "radar", name: "Classements Mondiaux", visible: true, order: 1 },
      { key: "artist", name: "Artistes Internationaux", visible: true, order: 2 },
      { key: "album", name: "Nouvelles Sorties", visible: true, order: 3 },
      { key: "radio", name: "Podcasts", visible: false, order: 4 },
    ],
