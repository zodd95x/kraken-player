...
import { tryAutoStartMcp, stopMcpServer } from "./services/mcp";
...
import { configureUserDataPath, migrateLegacyUserData } from "./utils/user-data-migration";
...
class MainProcess {
  ...
  constructor() {
    ...
    app.whenReady().then(async () => {
      ...
      // 设置应用程序名称
      electronApp.setAppUserModelId("com.krakenplayer.app");
      // 启动主服务进程
      await initAppServer();
      // 启动窗口
